    ...
    try {
        while (travelled < budget) {
            ...
            if (failed === 'behind' || failed === 'need_portal') {
                ...
                // walkOneLeg вернул behind быстро → без капа это soft busy-loop
                if (spinWithoutStep > 12) return finish('behind_spin');
                continue;
            }
