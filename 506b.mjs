...
const clanOwnerWatch = createClanOwnerBanWatch({ anarchy: 506, rootDir: __dirname });
...
// ========== КОНСТАНТЫ ==========
const botsPath = join(__dirname, './bots/506b.json');
const token = '8703392993:AAHWKcw2eu6nz9XY3nwxgH1IYD_gjZ_ExLg';
...
startLogRotate([
    join(__dirname, 'logs/506.log'),
    join(__dirname, '506.log'),
